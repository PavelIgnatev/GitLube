...
Сбор статистики происходит автоматически по мере накопления запросов для их отправки на сервер
...
Просмотреть статистику можно запустив приложение и открыв консоль или же - перейдя по этой ссылке
